 ...
 * pattern. The preconnect hint is handled separately via ghe_resource_hints().
 *
 * @param string $html   The full <link> tag HTML generated by WordPress.
 * @param string $handle The registered style handle.
 * @return string
 */
function ghe_typekit_non_blocking_loader( string $html, string $handle ): string {
 ...
 * @return string
 */
function ghe_google_fonts_non_blocking_loader( string $html, string $handle ): string {
	if ( 'google-fonts' !== $handle ) {
		return $html;
	}

	return '<link rel="preload" href="https://fonts.googleapis.com/css2?family=Gilda+Display&display=swap" as="style" crossorigin onload="this.onload=null;this.rel=\'stylesheet\'">' . "\n"
		. '<noscript><link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Gilda+Display&display=swap"></noscript>' . "\n";
}
add_filter( 'style_loader_tag', 'ghe_google_fonts_non_blocking_loader', 10, 2 );
