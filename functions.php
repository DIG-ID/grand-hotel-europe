...
function ghe_theme_enqueue_styles() {
	...
	wp_enqueue_style( 'typekit-fonts', 'https://use.typekit.net/lmo5nfm.css', array(), $theme_version );

	wp_enqueue_style( 'google-fonts', 'https://fonts.googleapis.com/css2?family=Gilda+Display&display=swap', array(), $theme_version );
