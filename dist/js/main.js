...
window.addEventListener("load", function () {
  if (document.querySelector(".single-zimmer") || document.querySelector(".single-suiten")) {
    ...
    var slider = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.gallery-images-swiper', {
      slidesPerView: 1,
      loop: true,
      speed: 900,
      effect: 'slide',
  ...
  if (document.querySelector(".single-bankette") || document.querySelector(".single-seminare")) {
    var _thumbs = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.gallery-thumbs-swiper-bs', {
      slidesPerView: 'auto',
      spaceBetween: 14,
      loop: true,
      centeredSlides: true,
    ...
    var _slider = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.gallery-images-swiper-bs', {
      slidesPerView: 1,
      loop: true,
      speed: 900,
      effect: 'slide',
      ...
      on: {
        afterInit: function afterInit() {
          _thumbs.update();
          _thumbs.slideToLoop(this.realIndex, 0);
        },
        slideChange: function slideChange() {
          _thumbs.slideToLoop(this.realIndex, 300);
        }
      }
    });
  }
  ...
  if (document.querySelector(".page-template-page-region")) {
    var initScopedButtonsSwiper = function initScopedButtonsSwiper(_ref) {
      var sectionSelector = _ref.sectionSelector,
        swiperSelector = _ref.swiperSelector,
      ...
      if (!swiperEl) return;
      var swiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](swiperEl, {
        slidesPerView: 1,
        spaceBetween: 0,
        speed: 600,
        allowTouchMove: true,
      ...
      var bindButtons = function bindButtons() {
        var nextButtons = section.querySelectorAll(nextSelector);
        var prevButtons = section.querySelectorAll(prevSelector);
