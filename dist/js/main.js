...
/* harmony import */ var _stickyHeader__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./stickyHeader */ "./assets/js/stickyHeader.js");
/* harmony import */ var _stickyHeader__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_stickyHeader__WEBPACK_IMPORTED_MODULE_2__);
...
function initMegaMenu() {
  ...
  var overlay = mega.querySelector(".js-mega-overlay");
  var panel = mega.querySelector(".js-mega-panel");
  var items = mega.querySelectorAll(".js-mega-item");
  ...
  // Start closed
  tl.reverse(0);
  var setOpenState = function setOpenState(isOpen) {
  ...
  overlay === null || overlay === void 0 || overlay.addEventListener("click", close);
...
(function grandHotelEuropeStickyHeaderIIFE() {
  ...
  function grandHotelEuropeOnScroll(yFromAdapter) {
    if (!ticking) {
      ...
      window.requestAnimationFrame(function () {
        return grandHotelEuropeUpdate(yFromAdapter);
      });
    }
  }
  ...
  window.addEventListener("scroll", function () {
    return grandHotelEuropeOnScroll();
  }, {
    passive: true
  });
  ...
  if (window.lenis && typeof window.lenis.on === "function") {
    window.lenis.on("scroll", function (_ref) {
      ...
      return grandHotelEuropeOnScroll(scroll);
    });
  }
