...
<section id="activities-section" class="activities-section bg-cream xl:bg-white mb-20 md:mb-24 xl:mb-32">
  <div class="theme-container">
    <div class="theme-grid">
      <div class="col-start-1 col-span-2 md:col-span-6 xl:col-span-12 bg-cream pt-8 md:pt-12 xl:pt-16">
                        ...
                        <div class="col-span-2 md:col-span-3 xl:col-start-2 xl:col-span-5 order-2 md:order-none">
                          <?php if ( $img_2_id ) : ?>
                            <div class="w-full overflow-hidden">
                              <?php
                                if ( $img_2_id ) :
                                echo wp_get_attachment_image( $img_2_id, 'full', false, array( 'class' => 'w-full h-auto min-h-56 max-h-56 md:max-h-none md:h-[436px] xl:h-[350px] object-cover' ) );
                                endif;
                                ?>
                            </div>
                          <?php endif; ?>
