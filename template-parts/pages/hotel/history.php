      ...
      <div class="repeater-wrapper col-start-1 col-span-2 md:col-span-6 xl:col-span-12 grid gap-y-16 md:gap-y-7 pt-12 md:pt-5 xl:pt-12">
        <?php if ( have_rows('history_repeater') ) : ?>
          ...
          ?>
            ...
            <!--
              Mobile: 1 column stacked (title -> text -> image)
              md/xl: same layout as before (image left, text right)
            -->
            <div class="grid grid-cols-1 md:grid-cols-6 xl:grid-cols-12 xl:grid-rows-2 gap-x-5 xl:gap-x-7 gap-y-6 md:gap-y-8">

              <!-- Title + Text (first on mobile, right on md/xl) -->
              <div class="col-span-1 md:col-span-3 xl:col-span-6 xl:row-span-2 order-1 md:order-2">
                <?php if ( $title ) : ?>
              ...
              <!-- Image (last on mobile, left on md/xl) -->
              <div class="col-span-1 md:col-span-3 xl:col-span-6 xl:row-span-2 order-3 md:order-1">
                <figure class="w-full h-full">
                  ...
                  if ( $img_id ) :
                    echo wp_get_attachment_image(
                      ...
                      false,
                      array(
                        'class' => 'w-full h-[400px] md:h-[436px] xl:h-[500px] object-cover'
                      )
                    );
                  endif;
                  ?>
