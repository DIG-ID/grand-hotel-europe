...
<section id="terrace-section" class="terrace-section bg-cream pb-16 md:pb-20 xl:pb-28">
    <div class="theme-container">
        ...
        <div class="theme-grid">
            <div class="col-start-1 col-span-2 md:col-start-1 md:col-span-6 xl:col-start-2 xl:col-span-10 bg-white framed__symmetric--bottom-right framed__symmetric--top-left relative grid grid-cols-2 md:grid-cols-6 xl:grid-cols-10 gap-x-5 xl:gap-x-7">
                
                <div class="col-start-1 col-span-2 md:col-start-2 md:col-span-4 xl:col-start-1 xl:col-span-5 pt-6 md:pt-8 xl:pt-12 xl:pl-6">
