...
<section id="section-outro" class="section-outro relative bg-cover bg-center bg-no-repeat" style="<?php echo $bg_outro_url ? 'background-image: linear-gradient(to bottom, rgba(34,34,34,0) 0%, rgba(34,34,34,0) 77%, rgba(34,34,34,1) 77%, rgba(34,34,34,1) 100%), url(' . esc_url($bg_outro_url) . ');' : 'background-color:#222222;'; ?>">
  ...
  <div class="theme-container py-24 md:py-28 xl:pb-24 xl:pt-20 relative z-10">
    <div class="theme-grid">
      ...
      <div class="col-span-2 md:col-span-3 xl:col-span-6">
        <h2 class="title-secondary text-white"><?php the_field( 'outro_title' ); ?></h2>
      </div>
      <div class="col-span-2 md:col-span-3 xl:col-span-6">
  ...
  <div class="theme-container relative z-10 bg-cream">
    <div class="theme-grid pt-20 pb-24">
      <div class="col-span-2 md:col-span-6 xl:col-span-9 pl-14">
        <p class="overtitle text-dark-2 mb-4"><?php the_field( 'outro_overtitle', 'option' ); ?></p>
        <h2 class="title-secondary text-dark-2 mb-6"><?php the_field( 'outro_title', 'option' ); ?></h2>
      ...
      <div class="col-span-2 md:col-span-3 xl:col-span-3 flex flex-col justify-center">
        <?php 
