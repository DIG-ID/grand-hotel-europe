...
<section id="hero" class="hero-section relative overflow-hidden min-h-[70dvh] flex flex-col justify-center md:block md:min-h-0 pt-0 md:pt-80 md:pb-80 xl:pt-[22.13rem] xl:pb-48 text-center <?php echo ($rb_id_desktop || $rb_id_mobile) ? '' : 'bg-darker'; ?>">
